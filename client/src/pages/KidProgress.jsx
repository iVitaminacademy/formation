...
const topics = [
  { id: 1, name: 'Multiplication', icon: '✖️', progress: 66, color: '#F97316', bg: '#FFF7ED' },
  { id: 2, name: 'Division',       icon: '➗', progress: 30, color: '#3B82F6', bg: '#EFF6FF' },
  { id: 3, name: 'Fractions',      icon: '½',  progress: 0,  color: '#EC4899', bg: '#FDF2F8' },
  { id: 4, name: 'Geometry',       icon: '📐', progress: 55, color: '#A855F7', bg: '#FAF5FF' },
]
...
const statCards = [
  { value: `${stats.overall}%`,          label: 'Overall Grade 4',   color: '#16A34A', border: '#86EFAC'  },
  { value: stats.lessonsCompleted,        label: 'Lessons completed', color: '#3B82F6', border: '#93C5FD'  },
  { value: `🔥 ${stats.streak}`,         label: 'Day streak',        color: '#F97316', border: '#FED7AA'  },
  { value: `🏅 ${stats.badgesEarned}`,   label: 'Badges earned',     color: '#EC4899', border: '#F9A8D4'  },
]
            ...
            {topics.map(topic => (
              ...
              >
                <div className="flex items-center justify-between mb-1.5">
                  ...
                  <span className="text-sm font-extrabold" style={{ color: topic.color }}>{topic.progress}%</span>
                </div>
          ...
          <div className="flex flex-col gap-2">
            {quizHistory.map(quiz => {
              ...
              return (
                <div
                  key={quiz.id}
                  className="flex items-center gap-3 py-3 border-b last:border-0 rounded-xl px-2 transition-colors cursor-pointer"
